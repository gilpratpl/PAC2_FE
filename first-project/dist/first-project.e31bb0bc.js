...
function setLikeItemStorage(id) {
  var selectedBooks = document.querySelectorAll('.ic-active');

  var booksIds = _toConsumableArray(selectedBooks).map(function (book) {
    return book.id;
  });
...
//# sourceMappingURL=/first-project.e31bb0bc.js.map